    ...
    <div class="main-container">
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-content active">
                        <div class="accordion-links">
                            ...
                            <a href="<?php echo e(route('promociones.create')); ?>" class="accordion-link" style="color: #00d4ff; border-left-color: #00d4ff; background: rgba(0, 212, 255, 0.1);">➕ Agregar Promoción</a>
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
        ...
        <div class="content-wrapper">
            ...
            <div class="form-container">
                <form action="<?php echo e(route('promociones.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="tipo" id="tipo" class="form-control" required>
                            <option value="general" <?php echo e(old('tipo') == 'general' ? 'selected' : ''); ?>>General</option>
                            <option value="descuento" <?php echo e(old('tipo') == 'descuento' ? 'selected' : ''); ?>>Descuento</option>
                            <option value="boleteria" <?php echo e(old('tipo') == 'boleteria' ? 'selected' : ''); ?>>Boleteria</option>
                            <option value="promociones" <?php echo e(old('tipo') == 'promociones' ? 'selected' : ''); ?>>Promociones</option>
                            <option value="confiteria" <?php echo e(old('tipo') == 'confiteria' ? 'selected' : ''); ?>>Confiteria</option>
                            <option value="combos" <?php echo e(old('tipo') == 'combos' ? 'selected' : ''); ?>>Combos</option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" name="descuento" id="descuento" class="form-control" value="<?php echo e(old('descuento')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="fecha_inicio" id="fecha_inicio" class="form-control" value="<?php echo e(old('fecha_inicio')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="fecha_fin" id="fecha_fin" class="form-control" value="<?php echo e(old('fecha_fin')); ?>" required>
...
<?php /**PATH C:\Users\Dixon\Desktop\cine_laravel\resources\views/promociones/create.blade.php ENDPATH**/ ?>