    ...
    <div class="promociones-section">
        <div class="promociones-grid">
            <?php $__empty_1 = true; $__currentLoopData = $promociones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promocion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="promo-card" data-tipo="<?php echo e($promocion->tipo); ?>">
                    <div class="promo-image-container">
                        <?php if($promocion->imagen): ?>
                            <img src="<?php echo e(asset('storage/'.$promocion->imagen)); ?>" alt="<?php echo e($promocion->titulo); ?>" class="promo-image">
                        <?php else: ?>
                            <img src="https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=800&h=500&fit=crop" alt="<?php echo e($promocion->titulo); ?>" class="promo-image">
                        <?php endif; ?>
                        
                        <?php if($promocion->descuento): ?>
                            <div class="promo-discount-overlay"><?php echo e($promocion->descuento); ?>% OFF</div>
                        <?php endif; ?>
                        
                        <div class="promo-badge badge-<?php echo e($promocion->tipo); ?>">
                            <?php echo e(ucfirst($promocion->tipo)); ?>

                        </div>
                    </div>
                    
                    <div class="promo-content">
                        <h3 class="promo-title"><?php echo e($promocion->titulo); ?></h3>
                        <p class="promo-description"><?php echo e($promocion->descripcion); ?></p>
                        
                        <div class="promo-meta">
                            <div class="promo-date">
                                📅 Válido hasta: <?php echo e($promocion->fecha_fin->format('d/m/Y')); ?>
                        ...
                        <?php if($promocion->codigo): ?>
                            <div style="margin-bottom: 1rem;">
                                <span class="promo-code"><?php echo e($promocion->codigo); ?></span>
                            </div>
                        <?php endif; ?>
...
</html><?php /**PATH C:\Users\Dixon\Desktop\cine_laravel\resources\views/user/promociones.blade.php ENDPATH**/ ?>