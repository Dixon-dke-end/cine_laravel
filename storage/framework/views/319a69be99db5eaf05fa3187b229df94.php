...
<body>
        ...
        <div class="content">
            ...
            <div class="payment-section">
                ...
                <button class="btn-pay" id="btnPagar">
                    PAGAR $<?php echo e(number_format($pedido->total, 0, ',', '.')); ?>
            ...
            <div class="summary-section">
                ...
                <div class="products-list">
                    ...
                    <div class="product-item">
                        <div class="product-info">
                            <div class="product-name"><?php echo e($item->producto->nombre); ?></div>
                            <div class="product-quantity">Cantidad: <?php echo e($item->cantidad); ?></div>
                        </div>
                        <div class="product-price">
                            $<?php echo e(number_format($item->precio_unitario * $item->cantidad, 0, ',', '.')); ?>
                ...
                <div class="price-breakdown">
                    <div class="price-row">
                        <span>Subtotal (<?php echo e($pedido->productos->sum('cantidad')); ?> productos)</span>
    ...
    <script>
        const pedidoId = <?php echo e($pedido->id); ?>;
        const total = <?php echo e($pedido->total); ?>;
...
<?php /**PATH C:\Users\Dixon\Desktop\cine_laravel\resources\views/pagos/checkout-confiteria.blade.php ENDPATH**/ ?>