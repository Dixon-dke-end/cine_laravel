        ...
        <div class="content">
            ...
            <div class="payment-section">
                ...
                <button class="btn-pay" id="btnPagar">
                    PAGAR $<?php echo e(number_format($total, 0, ',', '.')); ?>
            ...
            <div class="summary-section">
                ...
                <div class="movie-info">
                    ...
                    <div class="movie-details">
                        ...
                        <div class="movie-meta">
                            <strong>Sala:</strong> <?php echo e($reserva->funcion->Sala->nombre_sala); ?>

                        </div>
                        <div class="movie-meta">
                            <strong>Fecha:</strong> <?php echo e(\Carbon\Carbon::parse($reserva->funcion->hora)->format('d/m/Y H:i')); ?>

                        </div>
                        <div class="movie-meta">
                            <strong>Asientos:</strong> <?php echo e($reserva->cantidad_asientos); ?>
                ...
                <div class="seats-list">
                    ...
                    <div class="seats-badges">
                        <?php $__currentLoopData = $reserva->sillas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reservaSilla): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="seat-badge">
                                <?php echo e($reservaSilla->silla->fila); ?><?php echo e($reservaSilla->silla->numero); ?>
                ...
                <div class="price-breakdown">
                    <div class="price-row">
                        <span>Entradas (<?php echo e($reserva->cantidad_asientos); ?>)</span>
...
</html><?php /**PATH C:\Users\Dixon\Desktop\cine_laravel\resources\views/pagos/checkout.blade.php ENDPATH**/ ?>