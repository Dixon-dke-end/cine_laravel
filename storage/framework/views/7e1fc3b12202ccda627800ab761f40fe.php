    ...
    <div class="movie-header">
        ...
        <div class="right-column">
            ...
            <div class="schedule-section">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $funciones->groupBy('sala.nombre'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salaNombre => $funcionesSala): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="cinema-card">
                    <div class="cinema-header" onclick="toggleCinema(this)">
                        <div>
                            <div class="cinema-name">🎭 <?php echo e($salaNombre); ?></div>
                            <div class="cinema-address">📍 <?php echo e($funcionesSala->first()->sala->ubicacion ?? 'Sala Principal'); ?></div>
                        </div>
                    ...
                    <div class="showtimes-container">
                        ...
                        <div class="date-tabs">
                            ...
                            <?php $__currentLoopData = $fechasUnicas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $fecha): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="date-tab <?php echo e($index === 0 ? 'active' : ''); ?>" 
                                 onclick="filterByDate(this, '<?php echo e($fecha); ?>', '<?php echo e($salaNombre); ?>')">
                                <div style="font-weight: bold;"><?php echo e(\Carbon\Carbon::parse($fecha)->locale('es')->isoFormat('ddd')); ?></div>
                                <div style="font-size: 0.9rem;"><?php echo e(\Carbon\Carbon::parse($fecha)->format('d/m')); ?></div>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>

                        <!-- Showtimes Grid -->
                        <?php $__currentLoopData = $fechasUnicas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fecha): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="showtimes-grid" 
                             data-sala="<?php echo e($salaNombre); ?>" 
                             data-fecha="<?php echo e($fecha); ?>"
                             style="<?php echo e($fecha === $fechasUnicas->first() ? '' : 'display: none;'); ?>">
                            
                            <?php $__currentLoopData = $funcionesSala->filter(function($funcion) use ($fecha) {
                                return \Carbon\Carbon::parse($funcion->hora)->format('Y-m-d') === $fecha;
                            }); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $funcion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button class="showtime-btn" 
                                    onclick="reservarFuncion(<?php echo e($funcion->id); ?>)"
...
</html><?php /**PATH C:\backup\cine_laravel\resources\views/user/user_func.blade.php ENDPATH**/ ?>