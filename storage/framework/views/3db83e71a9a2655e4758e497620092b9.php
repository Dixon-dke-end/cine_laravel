        ...
        <aside class="sidebar">
            ...
            <?php if(auth()->guard()->check()): ?>
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        <div class="accordion-links">
                            <a href="<?php echo e(route('confiteria.index')); ?>" class="accordion-link">📋 Ver Confitería</a>
                            <a href="<?php echo e(route('confiteria.create')); ?>" class="accordion-link">➕ Agregar Confitería</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="content-wrapper">
            <div class="content">
                ...
                <div class="form-section">
                    ...
                    <form action="<?php echo e(route('reportes.generar')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="form-grid">
                            <div class="form-group">
                                <label for="mes">Mes</label>
                                <select name="mes" id="mes" required>
                                    <option value="1" <?php echo e((isset($mesActual) && $mesActual == 1) ? 'selected' : ''); ?>>Enero</option>
                                    <option value="2" <?php echo e((isset($mesActual) && $mesActual == 2) ? 'selected' : ''); ?>>Febrero</option>
                                    <option value="3" <?php echo e((isset($mesActual) && $mesActual == 3) ? 'selected' : ''); ?>>Marzo</option>
                                    <option value="4" <?php echo e((isset($mesActual) && $mesActual == 4) ? 'selected' : ''); ?>>Abril</option>
                                    <option value="5" <?php echo e((isset($mesActual) && $mesActual == 5) ? 'selected' : ''); ?>>Mayo</option>
                                    <option value="6" <?php echo e((isset($mesActual) && $mesActual == 6) ? 'selected' : ''); ?>>Junio</option>
                                    <option value="7" <?php echo e((isset($mesActual) && $mesActual == 7) ? 'selected' : ''); ?>>Julio</option>
                                    <option value="8" <?php echo e((isset($mesActual) && $mesActual == 8) ? 'selected' : ''); ?>>Agosto</option>
                                    <option value="9" <?php echo e((isset($mesActual) && $mesActual == 9) ? 'selected' : ''); ?>>Septiembre</option>
                                    <option value="10" <?php echo e((isset($mesActual) && $mesActual == 10) ? 'selected' : ''); ?>>Octubre</option>
                                    <option value="11" <?php echo e((isset($mesActual) && $mesActual == 11) ? 'selected' : ''); ?>>Noviembre</option>
                                    <option value="12" <?php echo e((isset($mesActual) && $mesActual == 12) ? 'selected' : ''); ?>>Diciembre</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="año" id="año" required>
                                    <option value="2023" <?php echo e((isset($añoActual) && $añoActual == 2023) ? 'selected' : ''); ?>>2023</option>
                                    <option value="2024" <?php echo e((isset($añoActual) && $añoActual == 2024) ? 'selected' : ''); ?>>2024</option>
                                    <option value="2025" <?php echo e((isset($añoActual) && $añoActual == 2025) ? 'selected' : ''); ?>>2025</option>
                                    <option value="2026" <?php echo e((isset($añoActual) && $añoActual == 2026) ? 'selected' : ''); ?>>2026</option>
                                </select>
                            </div>
                ...
                <?php if(isset($reporte)): ?>
                    <div class="report-header">
                        <h2>📈 Reporte: <?php echo e($reporte['mes']); ?> <?php echo e($reporte['año']); ?></h2>
                        <p>Resumen de actividades y ventas del período seleccionado</p>
                        <a href="<?php echo e(route('reportes.exportarPDF', ['mes' => $mesActual, 'año' => $añoActual])); ?>" 
...
<?php /**PATH C:\Users\Dixon\Desktop\cine_laravel\resources\views/reportes/index.blade.php ENDPATH**/ ?>