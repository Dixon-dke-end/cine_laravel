    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <div class="navbar-user">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('confiteria.create')); ?>" class="btn-add-navbar">
                        ➕ Agregar Producto
                    </a>
                <?php endif; ?>
            </div>
                            ...
                            <div class="product-card">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-meta">
                                        ...
                                        <div class="product-stock <?php echo e($producto->stock < 10 ? 'stock-low' : 'stock-ok'); ?>">
                                    ...
                                    <div class="product-actions">
                                        ...
                                        <form action="<?php echo e(route('confiteria.destroy', $producto->id)); ?>" 
                                              ...
                                              onsubmit="return confirmDelete(event, '<?php echo e($producto->nombre); ?>')">
                                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Dixon\Desktop\cine_laravel\resources\views/confiteria/admin_index.blade.php ENDPATH**/ ?>