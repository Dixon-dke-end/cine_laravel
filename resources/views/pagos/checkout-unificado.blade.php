...
<body>
        ...
        <div class="summary-card">
            ...
            <div class="movie-info">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">{{ $reserva->cantidad_asientos }} boleta(s)</span>
                </div>
            </div>
            ...
            <div class="confiteria-items">
                ...
                @foreach($pedidoConfiteria->productos as $item)
                ...
                <div class="confiteria-item" style="border: none; padding-top: 1rem;">
                    ...
                    <span style="font-weight: 600;">
                        ${{ number_format($pedidoConfiteria->cargo_servicio, 0, ',', '.') }}
                    </span>
                </div>
            </div>
            @endif
            ...
            <div class="total-section">
                <div class="total-row">
                    <span>Boletas</span>
                    <span style="font-weight: 700;">${{ number_format($totalReserva, 0, ',', '.') }}</span>
                </div>

                @if($totalConfiteria > 0)
                <div class="total-row">
                    <span>Confitería</span>
                    <span style="font-weight: 700;">${{ number_format($totalConfiteria, 0, ',', '.') }}</span>
                </div>
                @endif

                <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 1.5rem;">
                    <span style="font-size: 1.25rem; font-weight: 700;">TOTAL</span>
                    <span class="total-final">${{ number_format($totalFinal, 0, ',', '.') }}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        const pedidoId = {{ $pedidoConfiteria ? $pedidoConfiteria->id : 'null' }};
        ...
        // Timer de expiración
        const expiresAt = new Date('{{ $reserva->expires_at }}');
