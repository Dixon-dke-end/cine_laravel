        ...
        <div class="container">
            ...
            @else
                <div class="peliculas-funciones-container">
                    @foreach($confiteria as $pelicula)
                            ...
                            <div class="pelicula-header">
                                <div class="pelicula-info-header">
                                    ...
                                    <div class="pelicula-title-info">
                                        <h2 class="pelicula-title">{{ $pelicula->nombre }}</h2>
                                        <h2 class="pelicula-title">{{ $pelicula->precio }}</h2>
                                        <h2 class="pelicula-title">{{ $pelicula->stock }}</h2>
                                        <h2 class="pelicula-title">{{ $pelicula->descripcion }}</h2>
