            ...
            <div class="content">
                ...
                @if($movies->isEmpty())
                    <div class="empty-state">
                        ...
                        <a href="{{ route('proximamente.create') }}" class="btn-add">Agregar Primera Película</a>
                    </div>
                @else
                                ...
                                <div class="movie-card">
                                    ...
                                    <div class="movie-info">
                                        ...
                                        <div class="movie-actions">
                                            <form action="{{ route('proximamente.promover', $peli->id) }}" 
                                                  method="POST" 
                                                  onsubmit="return confirmPromote(event, '{{ $peli->titulo }}')">
                                                @csrf
                                                <button type="submit" class="btn btn-promote">
                                                    <span>🚀 Promover</span>
                                                </button>
                                            </form>
                                            <a href="{{ route('proximamente.edit', $peli->id) }}" class="btn btn-edit">
                                                <span>✏️ Editar</span>
                                            </a>
                                            <form action="{{ route('proximamente.destroy', $peli->id) }}" 
                                                  method="POST" 
