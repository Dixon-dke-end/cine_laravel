...
<body>
    ...
    <div class="main-container">
            ...
            @auth
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-content active">
                        <div class="accordion-links">
                            <a href="{{ route('promociones.index') }}" class="accordion-link" style="color: #00d4ff; border-left-color: #00d4ff; background: rgba(0, 212, 255, 0.1);">📋 Ver Promociones</a>
        ...
        <div class="content-wrapper">
            ...
            <a href="{{ route('promociones.create') }}" class="btn-add-promo">➕ Nueva Promoción</a>
                ...
                <table class="promociones-table">
                    ...
                    <tbody>
                        @foreach($promociones as $promo)
                            <tr>
                                <td>{{ $promo->titulo }}</td>
                                <td>{{ $promo->codigo ?? 'N/A' }}</td>
                                <td>{{ $promo->descuento ? $promo->descuento . '%' : 'N/A' }}</td>
                                ...
                                <td>
                                    <a href="{{ route('promociones.edit', $promo->id) }}" class="btn-action btn-edit">✏️ Editar</a>
                                    <form action="{{ route('promociones.destroy', $promo->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('¿Estás seguro de eliminar esta promoción?');">
                                        @csrf
                                        @method('DELETE')
