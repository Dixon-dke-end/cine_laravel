...
<body>
        ...
        <div class="card">
            ...
            <div class="header">
                <div class="icon success">
                    @if($reserva->estado === 'pagada' || $reserva->estado === 'confirmada')
                        ✅
                    @else
                        ⏳
                    @endif
            ...
            <div class="info-section">
                ...
                <div class="info-value">
                    <span class="reservation-id">#{{ str_pad($reserva->id, 6, '0', STR_PAD_LEFT) }}</span>
                </div>
            </div>
            ...
            <div class="info-section">
                ...
                <div class="info-value">
                    {{ $reserva->funcion->Sala->nombre_sala }}
                </div>
            </div>
            ...
            <div class="info-section">
                ...
                <div class="info-value">
                    {{ \Carbon\Carbon::parse($reserva->funcion->hora)->locale('es')->isoFormat('dddd DD [de] MMMM [de] YYYY [a las] HH:mm') }}
                </div>
            </div>
            ...
            <div class="info-section">
                ...
                <div class="info-value">
                    <strong>{{ $reserva->cantidad_asientos }} asiento(s)</strong>
                </div>
                <div class="seats-list">
                @forelse($reserva->sillas ?? [] as $silla)
                    {{-- código --}}
                @empty
            ...
            <div class="price-section">
                ...
                <div class="price-value">${{ number_format($reserva->precio_total, 2) }}</div>
            </div>
    ...
    <script>
        function proceedToPayment() {
            ...
            // window.location.href = '/payment/' + {{ $reserva->id }};
        }
    </script>
</body>
</html>
