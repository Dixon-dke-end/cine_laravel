...
<head>
    ...
    <title>{{ $promocion->titulo }} - CineVel</title>
...
<nav class="navbar">
    ...
    <div class="breadcrumbs">
        ...
        <a href="{{ route('promociones.user') }}">Promociones</a> &gt; 
        <span>{{ strtolower($promocion->titulo) }}</span>
    </div>

    <!-- Banner Image -->
    @if($promocion->imagen)
        <img src="{{ asset('storage/'.$promocion->imagen) }}" alt="{{ $promocion->titulo }}" class="promo-banner">
    @else
    ...
    <div class="content-container">
        <h1 class="promo-title">{{ $promocion->titulo }}</h1>
        ...
        <div class="details-grid">
            ...
            <div class="description-section">
                ...
                <h3>Asegura ya las tuyas <a href="{{ route('user.index') }}" style="color: #000; text-decoration: underline;">AQUÍ</a></h3>
            </div>
            ...
            <div class="conditions-box">
                ...
                <ul class="conditions-list">
                    <li>Promoción válida hasta {{ $promocion->fecha_fin->format('d/m/Y') }}.</li>
                    <li>Válido en todos los teatros CineVel a nivel nacional.</li>
                    <li>No acumulable con otras promociones.</li>
                    <li>Sujeto a disponibilidad de sala y formato.</li>
                    @if($promocion->codigo)
                        <li>Código de promoción: <strong>{{ $promocion->codigo }}</strong></li>
                    @endif
