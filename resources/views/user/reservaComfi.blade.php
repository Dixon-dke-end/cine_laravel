...
<head>
    ...
    <title>Confitería - {{ $reserva->funcion->movies->titulo }}</title>
    <style>
    ...
    <div class="main-container">
        ...
        <div class="reserva-summary">
            ...
            <div class="info-item">
                ...
                <div class="info-value">{{ $reserva->funcion->movies->titulo }}</div>
            </div>

            <div class="info-item">
                <div class="info-label">Sala</div>
                <div class="info-value">{{ $reserva->funcion->Sala->nombre_sala }}</div>
            </div>
            ...
            <div class="info-item">
                ...
                <div class="info-value">${{ number_format($reserva->precio_total, 0, ',', '.') }}</div>
            </div>
        ...
        <div class="products-section">
            ...
            <div class="products-grid">
                ...
                <div class="product-card">
                    <img src="{{ $producto->imagen ? asset('storage/' . $producto->imagen) : 'https://images.unsplash.com/photo-1585647347384-2593bc35786b?w=300&h=200&fit=crop' }}" 
                         alt="{{ $producto->nombre }}" 
                         class="product-image">
            ...
            <div class="cart-section">
                ...
                <div class="cart-item">
                    ...
                    <div class="cart-item-info">
                        <div style="font-weight: 700;">{{ $item->producto->nombre }}</div>
                        <div style="color: var(--primary); font-weight: 600;">
                            ${{ number_format($item->producto->precio, 0, ',', '.') }} × {{ $item->cantidad }}
                        </div>
                    </div>
                ...
                <div class="cart-summary">
                    ...
                    <div class="summary-row total">
                        ...
                        <span>${{ number_format($totalConfiteria, 0, ',', '.') }}</span>
                    </div>
                </div>
            </div>
            @endif
    ...
    <div class="bottom-actions">
        <div class="actions-container">
            <div class="total-display">
                Total: ${{ number_format($reserva->precio_total + ($totalConfiteria ?? 0), 0, ',', '.') }}
            </div>
            
            <div class="action-buttons">
                <!-- Omitir confitería -->
                <a href="{{ route('pagos.checkout', $reserva->id) }}" class="btn btn-skip">
                    Continuar sin Confitería
                </a>
                
                <!-- Agregar confitería y continuar -->
                @if($carrito->isNotEmpty())
                <form action="{{ route('pedidos.confiteria.crear') }}" method="POST" style="display: inline;">
                    @csrf
